...
// For now, we'll use simplified object storage without ACL
...
export class ObjectStorageService {
  ...
  async downloadObject(file: File, res: Response, cacheTtlSec: number = 3600) {
    try {
      ...
      // For now, make all images public for simplicity
      const isPublic = true;
  ...
  async getPublicObjectUploadURL(): Promise<{ uploadURL: string, publicPath: string }> {
    ...
    console.log("Public upload debug:", {
      publicPath,
      objectId,
      fullPath,
      bucketName,
    ...
    return {
      uploadURL,
      publicPath: `/public-objects/${objectId}`
    };
  }
  ...
  // For now, simplified approach without ACL
